        ...
        const cardData: CardData[] = [
          {
            ...
            image: forecast,
            content:
              lastEditedData.forecast !== undefined &&
              lastEditedData.forecast !== 0
                ? `Last edited ${returnLastTime(lastEditedData.forecast)} ago`
                : "",
          },
          {
            name: "Quick Overview",
            ...
            image: quickOverview,
            content:
              lastEditedData.quick_overview !== undefined &&
              lastEditedData.quick_overview !== 0
                ? `Last edited ${returnLastTime(
                    lastEditedData.quick_overview
                  )} ago`
                : "",
          },
          {
          ...
          },
          {
            ...
            image: typhoon,
            content:
              lastEditedData.typhoon !== undefined &&
              lastEditedData.typhoon !== 0
                ? `Last edited ${returnLastTime(lastEditedData.typhoon)} ago`
                : "",
            color:
              stormData === undefined || stormData.length === 0
                ? "green"
                : "red",
          },
          {
