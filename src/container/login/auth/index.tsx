...
import LoginImage from "../../../assets/vectos/login1111.jpg";
...
export default function AuthPage() {
  ...
  const [step, setStep] = useState<number | string | null>(localStorage.getItem("loginStep") ?? 1);
  const [password, setPassword] = useState<string>("");
  const [isAdmin, setIsAdmin] = useState<boolean>(localStorage.getItem("type") === "admin" ? true : false);
